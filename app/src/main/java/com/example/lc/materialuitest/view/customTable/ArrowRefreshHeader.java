...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	private void initView() {
		...
		mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(
				R.layout.view_list_view_header, null);
		...
		mArrowImageView = (ImageView)findViewById(R.id.iv_view_list_view_header_arrow);
		mStatusTextView = (TextView)findViewById(R.id.tv_view_list_view_refresh_status);

        //init the progress view
		mProgressBar = (SimpleViewSwitcher)findViewById(R.id.svs_view_list_view_header);
		...
		mHeaderTimeView = (TextView)findViewById(R.id.tv_view_list_view_refresh_time);
